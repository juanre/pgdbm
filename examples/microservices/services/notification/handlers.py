...
from shared.events import event_handler, EventTypes
from shared.database import SharedDatabaseManager
from shared.models import NotificationType, NotificationStatus
...
async def handle_low_stock_alert(event_data: dict):
    ...
    print(f"LOW STOCK ALERT: Product {event_data['sku']} has only {event_data['stock_quantity']} units left!")
