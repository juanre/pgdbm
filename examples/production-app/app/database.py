...
class DatabaseInfrastructure:
    ...
    async def initialize(self) -> None:
        ...
        logger.info(f"Created {len(self.managers)} service managers with schemas: {list(self.managers.keys())}")
    ...
    async def health_check(self) -> Dict[str, bool]:
        ...
        for service, manager in self.managers.items():
            try:
                ...
                await manager.fetch_val("SELECT 1")
                health[service] = True
            except Exception as e:
    ...
    def get_pool_stats(self) -> Dict[str, any]:
        ...
        return {
            ...
            "used_connections": self.shared_pool._size - self.shared_pool._freesize,
        }
